...
| Exact match | 17.6471% (9/51) | 80.3922% (41/51) |
| Unsupported-claim rate | 94.4444% (17/18) | 0% (0/33) |
| NOT_REPORTED accuracy | 100% (8/8) | 100% (8/8) |
...
for which no evidence-strict registry rule exists. No asserted AFTER prediction is
unsupported. Scientific correctness still requires the independent audit gate.
