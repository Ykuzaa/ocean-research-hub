...
Both runs use the three audited golden papers and the compact benchmark field set
(52 fields after this update added `evaluation.ablations` and extended
`evaluation.baselines` for OceanNet, grounded against its supplementary material).
...
| Metric | BEFORE | AFTER |
|---|---:|---:|
| Precision | 5.5556% (1/18) | 100% (34/34) |
| Recall | 2.3256% (1/43) | 77.2727% (34/44) |
| Exact match | 17.6471% (9/51) | 65.3846% (34/52) |
| Unsupported-claim rate | 94.4444% (17/18) | 0% (0/34) |
| NOT_REPORTED accuracy | 100% (8/8) | 0% (0/8) |
| Evidence-location accuracy | 0% (0/43) | 77.2727% (34/44) |
...
`NOT_REPORTED` assertion. No asserted AFTER prediction is unsupported. The newly
grounded OceanNet supplementary claims (`evaluation.baselines`, `evaluation.ablations`)
were located and validated against the fetched supplement PDF and contributed no
unsupported claims. Scientific correctness still requires the independent audit gate.
