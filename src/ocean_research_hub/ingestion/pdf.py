...
FOURDVAR_RULES = (
    ...
    ClaimRule("architecture.summary", "A trainable iterative 4D-Var solver combines a learned dynamical prior with an LSTM-based gradient-update operator.", (ev(2121, "2 4DVarNet framework", "iterative solver paragraph", r"LSTM.*?learn an adaptive gradient update.*?trainable gradient descent with momentum"),)),
